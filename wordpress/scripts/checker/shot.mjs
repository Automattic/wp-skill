...
// Browser discovery: bundled/cached Chromium, then system Chrome, then a Chromium channel, then
// chrome-headless-shell — the same fallback the editor gate uses. Don't pre-run
// `npx playwright install` (unsupported on some newer OSes, e.g. Ubuntu 26.04, and usually unnecessary).
